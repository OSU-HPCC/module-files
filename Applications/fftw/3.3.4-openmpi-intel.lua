...
--
prepend_path("PATH","/opt/fftw/3.3.4/openmpi-1.4-intel/bin")
prepend_path("CPATH","/opt/fftw/3.3.4/openmpi-1.4-intel/include")
prepend_path("LD_LIBRARY_PATH","/opt/fftw/3.3.4/openmpi-1.4-intel/lib")
prepend_path("INFOPATH","/opt/fftw/3.3.4/openmpi-1.4-intel/info")
